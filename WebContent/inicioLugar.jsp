		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Agregar Lugar</h3>                    
					</div>
				</div>
			</div>
									...
									<div class="row">
										...
										<form action="<%=request.getContextPath()%>/listar-lugares.do">
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreAgregarLugar" name="nombreAgregarLugar" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" required>
                              					<span class="bar"></span>
                            				...
                            				<div class="col-md-4">
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="direccionAgregarLugar" name="direccionAgregarLugar" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" required>
                              					<span class="bar"></span>
                          					...
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="opcionLugares" value="agregarLugar">Agregar Lugar</button>
                        					</div>
										</form>
										</div>
									</div>
