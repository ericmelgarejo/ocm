		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Modificar Destinatario</h3>                    
					</div>
				</div>
			</div>
							...
							<div class="responsive-table">
								<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<div class="row">
										...
										<c:forEach items="${listaDatosDestinatarios}" var="Destinatario">
										<input type="hidden" name="idDestinatario" value="${Destinatario.id_destinatario }">
										<div class="col-md-4">
                            			<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreModificarDestinatario" name="nombreModificarDestinatario" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" value="${Destinatario.nombre }"required>
                              					<span class="bar"></span>
                              					<label>Nombre del Destinatario</label>
                            				</div>
                            			 <!-- 		<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="estadoModificarDestinatario" name="estadoModificarDestinatario" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios"  value="${Destinatario.estado }" required>
                              					<span class="bar"></span>
                              					<label>Estado</label>
                            				</div>
                            			  -->		
                          					...
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="confirmarModificarDestinatario" value="confirmarModificarDestinatario">Modificar Destinatario</button>
                        					</div>
										</c:forEach>
