				...
				<div class="panel-body">
					<div class="col-md-12">
						<c:if test="${accion == 'crear'}">
							<h3 class="animated fadeInLeft">Crear Programa</h3>
						</c:if>
						<c:if test="${accion == 'modificar'}">
							<h3 class="animated fadeInLeft">Modificar Programa</h3>
						</c:if>	
					</div>
				</div>
			</div>
			...
			<div class="col-md-12 padding-0">
				<div class="col-md-12">
					<div class="panel">
						...
						<div class="panel-body">
							<div class="col-md-12">
								<form class="cmxform" action="<%=request.getContextPath()%>/programa">
									...
									<div class="col-md-6">
										<div class="form-group form-animate-text" style="margin-top:40px !important;">
											<c:if test="${accion == 'crear'}">
												<input type="text" class="form-text" id="p_descripcion" name="descripcion" required aria-required="true">
											</c:if>
											<c:if test="${accion == 'modificar'}">
												<input type="text" class="form-text" id="p_descripcion" name="descripcion" required aria-required="true" value="${descripcion }">
											</c:if>
											<span class="bar"></span>
									...
									<div class="col-md-12">
										<c:if test="${accion == 'crear'}">
											...
											<button class="submit btn btn-danger">Crear</button>
										</c:if>
										<c:if test="${accion == 'modificar'}">
											<input type="hidden" name="opcion" value="actualizar">
											<button class="submit btn btn-danger">Modificar</button>
										</c:if>
									</div>
								</form>
							</div>
