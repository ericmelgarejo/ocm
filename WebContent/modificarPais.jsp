		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Modificar País</h3>                    
					</div>
				</div>
			</div>
							...
							<div class="responsive-table">
								<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<div class="row">
										...
										<c:forEach items="${listaDatosPais}" var="Pais">
										<input type="hidden" name="idPais" value="${Pais.ID_Pais }">
										<div class="col-md-4">
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreModificarPais" name="nombreModificarPais" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" value="${Pais.nombre }" required>
                              					<span class="bar"></span>
                          					...
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="confirmarModificarPais" value="confirmarModificarPais">Modificar País</button>
                        					</div>
										</c:forEach>
