		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Modificar Lugar</h3>                    
					</div>
				</div>
			</div>
						...
						<div class="panel-body">
							<div class="responsive-table">
								<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<div class="row">
										<div class="col-sm-12">
										<form action="<%=request.getContextPath()%>/listar-lugares.do">
										<c:forEach items="${listaDatosLugar}" var="Lugar">
										<input type="hidden" name="idLugar" value="${Lugar.id }">
                                  				...
                                  				<select class="form-control" name="selectCiudad">
													...
													<option value="0"> Selecciona una Ciudad...</option>
														<c:forEach items="${listaCiudades }" var = "Ciudad">
															<c:if test="${Ciudad.id == Lugar.ciudad_id}">
																<option selected id="${Ciudad.id }" value="${Ciudad.id }">${Ciudad.nombre }</option>
															</c:if>
															<c:if test="${Ciudad.id != Lugar.ciudad_id}">
																<option id="${Ciudad.id }" value="${Ciudad.id }">${Ciudad.nombre }</option>
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreModificarLugar" name="nombreModificarLugar" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" value="${Lugar.nombre }" required>
                              					<span class="bar"></span>
                            				...
                            				<div class="col-md-4">
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="direccionModificarLugar" name="direccionModificarLugar" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" value="${Lugar.direccion }" required>
                              					<span class="bar"></span>
                          					...
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="confirmarModificarLugar" value="confirmarModificarLugar">Modificar Lugar</button>
                        					</div>
                        					</c:forEach>
										</form>
										</div>
