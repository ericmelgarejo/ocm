													...
													<c:if test="${not empty listaEventos}">
														<c:forEach items="${listaEventos}" var="Evento">
															<tr>
																...
																<td style="text-align: center;">${Evento.promocion}</td>
																<td style="text-align: center;">${Evento.nombre_curso}</td>
 																<td style="text-align: center;"><button class="btn btn-warning" name="preinscripcionEvento" value="${Evento.id_evento }">Preinscripciones</button></td>
