													...
													<c:if test="${not empty listaEventos}">
														<c:forEach items="${listaEventos}" var="Evento">
															<tr>
																...
																<td style="text-align: center;">${Evento.descripcion}</td>
																...
																<td style="text-align: center;">${Evento.nombre_lugar}</td>
																<td style="text-align: center;">${Evento.nombre_instructor}</td>
																<c:if test="${Evento.promocion == 'SEB' }">
																	<td style="text-align: center;">Super Early Bird</td>
																</c:if>
																<c:if test="${Evento.promocion == 'EB' }">
																	<td style="text-align: center;">Early Bird</td>
																</c:if>
																<c:if test="${Evento.promocion == '10' }">
																	<td style="text-align: center;">10% para 2 personas</td>
																</c:if>
																<c:if test="${Evento.promocion == '15' }">
																	<td style="text-align: center;">15% para 3 personas</td>
																</c:if>
																<c:if test="${Evento.promocion == 'na' }">
																	<td style="text-align: center;">Sin promoción</td>
																</c:if>
