		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Ver Instructores</h3>                    
					</div>
				</div>
			</div>
			...
			<div class="col-md-11">
			<div class="col-md-1">
				<button class="btn btn-success" style="font-size:20px!important;" onclick="window.location.href='agregarInstructor.jsp'">+</button>
			</div>
			</div>
									...
									<div class="row">
										...
										<form action="<%=request.getContextPath()%>/listar-instructores.do">
											<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
												...
												<tbody>
													<c:if test="${not empty listaInstructores}">
														<c:forEach items="${listaInstructores}" var="Instructor">
															<tr>
																<td style="text-align: center;">${Instructor.nombre}</td>
																<td style="text-align: center;">${Instructor.apellido_paterno}</td>
																<td style="text-align: center;">${Instructor.apellido_materno}</td>
																<td style="text-align: center;">${Instructor.correo}</td>
																<td style="text-align: center;">${Instructor.telefono}</td>
																<td style="text-align: center;">${Instructor.fecha_nacimiento}</td>
 																
 																<td style="text-align: center;"><button class="btn btn-warning" name="modificarInstructor" value="${Instructor.id_instructor }">Modificar</button></td>
																<td style="text-align: center;"><button class="btn btn-danger" name="eliminarInstructor" value="${Instructor.id_instructor }">Eliminar</button></td>
