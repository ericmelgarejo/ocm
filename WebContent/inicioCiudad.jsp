		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Agregar Ciudad</h3>                    
					</div>
				</div>
			</div>
									...
									<div class="row">
										...
										<form action="<%=request.getContextPath()%>/listar-ciudades.do">
											<div class="col-md-4">
                          					...
                          					<p>País:</p>	
                                  				<select class="form-control" name="selectPais">
													<option value="0" selected>Seleccione el país...</option>
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreAgregarCiudad" name="nombreAgregarCiudad" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" required>
                              					<span class="bar"></span>
                          					...
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="opcionCiudades" value="agregarCiudad">Agregar Ciudad</button>
                        					</div>
										</form>
										</div>
									</div>
