		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Modificar Instructor</h3>                    
					</div>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="panel">
						...
						<div class="panel-body">
										...
										<c:forEach items="${listaDatosInstructor}" var="Instructor">
										<input type="hidden" name="idInstructor" id="idInstructor" value="${Instructor.id_instructor }">
										<div class="col-md-6">
                            			<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreModificarInstructor" name="nombreModificarInstructor" class="form-text"  title="Solo letras numeros y espacios" value="${Instructor.nombre }"required>
                              					<span class="bar"></span>
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					...
                              					<input type="text" id="apellidopModificarInstructor" name="apellidopModificarInstructor" class="form-text" title="Solo letras numeros y espacios"  value="${Instructor.apellido_paterno }" required>
                              					<span class="bar"></span>
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					...
                              					<input type="text" id="apellidomModificarInstructor" name="apellidomModificarInstructor" class="form-text" title="Solo letras numeros y espacios" value="${Instructor.apellido_materno }" required>
                              					<span class="bar"></span>
                            				...
                            				<div class="col-md-6">
                            					<div class="form-group form-animate-text" style="margin-top:40px !important;">
                            					<input type="text" id="correoModificarInstructor" name="correoModificarInstructor" class="form-text" title="Solo letras numeros y espacios" value="${Instructor.correo }" required>
                              					<span class="bar"></span>
                              					<label>Correo</label>
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="telefonoModificarInstructor" name="telefonoModificarInstructor" class="form-text" title="Solo letras numeros y espacios" value="${Instructor.telefono }" required>
                              					<span class="bar"></span>
                            				...
                            				<div class="form-group form-animate-text">
                              					<input type="text" id="fechanModificarInstructor" name="fechanModificarInstructor" class="form-text"  title="Solo letras numeros y espacios"  value="${Instructor.fecha_nacimiento }" required>
                              					<span class="bar"></span>
                            				...
                            				<div class="col-md-5"></div>
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="confirmarModificarInstructor" value="confirmarModificarInstructor">Modificar Instructor</button>
                        					</div>
										</c:forEach>
