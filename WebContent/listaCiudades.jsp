		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Ver Ciudades</h3>                    
					</div>
				</div>
			</div>
			...
			<div class="col-md-11">
			<div class="col-md-1">
				<button class="btn btn-success" style="font-size:20px!important;" onclick="window.location.href='<%=request.getContextPath()%>/listar-ciudades.do?opcionCiudades=inicioAltaCiudad'">+</button>
			</div>
			</div>
						...
						<div class="panel-body">
							<div class="responsive-table">
								<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<div class="row">
										<div class="col-sm-12">
										<form action="<%=request.getContextPath()%>/listar-ciudades.do">
											<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
												...
												<tbody>
													<c:if test="${not empty listaCiudades2}">
														<c:forEach items="${listaCiudades2}" var="Ciudades">
															<tr>
																<td style="text-align: center;">${Ciudades.pais_nombre}</td>
 																<td style="text-align: center;">${Ciudades.nombre}</td>
 																<td style="text-align: center;"><button class="btn btn-warning" name="modificarCiudad" value="${Ciudades.id }">Modificar</button></td>
																<td style="text-align: center;"><button class="btn btn-danger" name="eliminarCiudad" value="${Ciudades.id }">Eliminar</button></td>
