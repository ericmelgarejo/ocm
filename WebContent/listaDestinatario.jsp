		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Ver Destinatarios</h3>                    
					</div>
				</div>
			</div>
			...
			<div class="col-md-11">
			<div class="col-md-1">
				<button class="btn btn-success" style="font-size:20px!important;" onclick="window.location.href='agregarDestinatario.jsp'">+</button>
			</div>
			</div>
						...
						<div class="panel-body">
							<div class="responsive-table">
								<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<div class="row">
										<div class="col-sm-12">
										<form method="post" action="<%=request.getContextPath()%>/listar-destinatarios.do">
											<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
												...
												<tbody>
													<c:if test="${not empty listaDestinatarios}">
														<c:forEach items="${listaDestinatarios}" var="Destinatario">
															<tr>
																<td style="text-align: center;">${Destinatario.nombre}</td>
																 <!-- <td style="text-align: center;">${Destinatario.estado}</td>
 																  -->	
 																<td style="text-align: center;"><button class="btn btn-warning" name="modificarDestinatario" value="${Destinatario.id_destinatario}">Modificar</button></td>
																<td style="text-align: center;"><button class="btn btn-danger" name="eliminarDestinatario" value="${Destinatario.id_destinatario}">Eliminar</button></td>
