		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Modificar Ciudad</h3>                    
					</div>
				</div>
			</div>
							...
							<div class="responsive-table">
								<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<div class="row">
										...
										<c:forEach items="${listaDatosCiudad}" var="Ciudad">
										<input type="hidden" name="idCiudad" value="${Ciudad.id }">
											<div class="col-md-4">
                          					<div class="col-sm-12 padding-0">
                          					<p>País:</p>	
                                  				<select class="form-control" name="selectPais">
													
													<option value="0" selected> Selecciona un Pais...</option>
														<c:forEach items="${listaPaises }" var = "Pais">
															<c:if test="${Pais.ID_Pais == Ciudad.pais_id}">
																<option selected id="${Pais.ID_Pais }" value="${Pais.ID_Pais }">${Pais.nombre }</option>
															</c:if>
															<c:if test="${Pais.ID_Pais != Ciudad.pais_id}">
                            				...
                            				<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              					<input type="text" id="nombreModificarCiudad" name="nombreModificarCiudad" class="form-text" pattern="[A-Za-z0-9 ]+" title="Solo letras numeros y espacios" value="${Ciudad.nombre }" required>
                              					<span class="bar"></span>
                          					...
                          					<div class="col-md-4">
                              				<button class="submit btn btn-danger" name="confirmarModificarCiudad" value="confirmarModificarCiudad">Modificar Ciudad</button>
                        					</div>
                        					</c:forEach>
										</form>
										</div>
