		...
		<!-- start: content -->
			...
			<div class="panel box-shadow-none content-header">
				<div class="panel-body">
					<div class="col-sm-12">
						<h3 class="animated fadeInLeft">Ver Lugares</h3>                    
					</div>
				</div>
			</div>
			...
			<div class="col-md-11">
			<div class="col-md-1">
				<button class="btn btn-success" style="font-size:20px!important;" onclick="window.location.href='<%=request.getContextPath()%>/listar-lugares.do?opcionLugares=inicioAltaLugar'">+</button>
			</div>
			</div>
									...
									<div class="row">
										...
										<form action="<%=request.getContextPath()%>/listar-lugares.do">
											<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
												...
												<tbody>
													<c:if test="${not empty listaLugares}">
														<c:forEach items="${listaLugares}" var="Lugares">
															<tr>
																<td style="text-align: center;">${Lugares.ciudad_nombre}</td>
 																<td style="text-align: center;">${Lugares.nombre}</td>
 																<td style="text-align: center;">${Lugares.direccion}</td>
 																<td style="text-align: center;"><button class="btn btn-warning" name="modificarLugar" value="${Lugares.id }">Modificar</button></td>
																<td style="text-align: center;"><button class="btn btn-danger" name="eliminarLugar" value="${Lugares.id }">Eliminar</button></td>
