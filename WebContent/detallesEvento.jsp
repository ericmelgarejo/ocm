        	...
        	<div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a><span class="fa-home fa"></span> Inicio 
                      </a>
                    </li>
                    
                    <li class="active ripple">
                      <a><span class="fa fa-plus-circle"></span> Nuevo Evento
                      </a>
                    </li>
                    
                    <li class="ripple">
                      <a><span class="fa fa-internet-explorer"></span> Lista Eventos
                      </a>
                    </li>
                    
                    <li class="ripple">
                      <a><span class="fa fa-amazon"></span> Prueba
                      </a>
                    </li>
